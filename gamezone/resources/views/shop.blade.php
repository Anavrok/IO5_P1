...
@section('content2')
	...
	<section class="recent-game-section spad set-bg" data-setbg="img/recent-game-bg.png">
		<div class="container">
			<div class="section-title">
				<div class="cata strategy">Nowości</div>
				<h2>Gry i Dodatki</h2>
			</div>
			<div class="row">
	...
	<section class="tournaments-section spad">
		<div class="container">
			<div class="tournament-title">Nowe Możliwości Personalizacji Profilu</div>
			<div class="row">
				<div class="col-md-6">
					<div class="tournament-item mb-4 mb-lg-0">
						...
						<div class="ti-content">
							...
							<div class="ti-text">
								<h4>AWATAR</h4>
								<ul>
									<li>Overwatch 2: Logo</li>
									<li><span>Data wydania: June 20, 2018</span></li>
								</ul>
								<a href="#" class="comment">Zobacz</a>
							</div>
						</div>
				...
				<div class="col-md-6">
					<div class="tournament-item">
						<div class="ti-notic" style="background: white; font-family: monospace;">750 <span style="background-color:BlueViolet; color:white; border-radius: 30px; padding: 5px 10px;">T</span></div>
						<div class="ti-content">
							<div class="ti-thumb set-bg" data-setbg="img/tournament/2.jpg"></div>
							<div class="ti-text">
								<h4>SZTANDAR</h4>
								<ul>
									<li>Dying Light 2: Powstanie</li>
									<li><span>Data wydania: June 20, 2018</span></li>
								</ul>
								<a href="#" class="comment">Zobacz</a>
							</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="footer-widget">
						<h4 class="fw-title">Ranking użytkowników</h4>
