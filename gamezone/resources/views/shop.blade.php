...
<div class="main-content position-relative max-height-vh-100 h-100">
    ...
    <div class="container-fluid px-2 px-md-4" >
	  ...
	  <div class="row gx-3 mb-2" style="width: 100%;  margin: 0; border-top-right-radius: 10px; border-top-left-radius: 10px;">
            ...
            <div class="h-100">
				<p class="mb-1">
				<center><a href="#" class="nakierowanie">Proponowane</a></center>
        </p>
            </div>
          </div>
          <div class="col-auto my-auto ramka" style="width: 24%; margin-left: 0.5%;">
            <div class="h-100">
			<p class="mb-1" >
			<center><a href="#" class="nakierowanie">Sklep z grami</a></center>
</p>
            </div>
          </div>
          <div class="col-auto my-auto ramka" style="width: 24%; margin-left: 0.5%;">
		  ...
		  <div class="col-auto my-auto ramka" style="width: 24%; margin-left: 0.5%;">
            <div class="h-100">
			<p class="mb-1">
            <center><a href="#" class="nakierowanie">Oferty</a></center>
</p>
            </div>
          </div>
      </div>
        ...
        @if($count < 6)
          <div class="col-auto" style="width: 20%; margin-top: 1%; margin-bottom: 1%;">
            <div class="position-relative">
              <a href="#"><img class="img" src="../img/games/{{ $game->image }}.jpg" alt="profile_image" class="border-radius-lg shadow-sm" style="width: 100%; height: 220px; border-radius: 10px;"></a>
            </div>
          </div>
          @php($count++)
        @endif
